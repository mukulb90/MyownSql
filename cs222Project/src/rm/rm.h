...
public:
	...
	RC getNextEntry(RID &rid, void *key) {
		return this->ixIterator->getNextEntry(rid, key);
	}
...
public:
	...
	RC getAllIndexOnTable(const string tableName, vector<Attribute> &attrs);
...
public:
	...
	static ColumnsCatalogRecord* parse(const int &tableId,
			const Attribute &attrs, const int &columnIndex, const int &version,
